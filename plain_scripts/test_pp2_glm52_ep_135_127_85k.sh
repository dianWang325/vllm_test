#!/usr/bin/env bash
# VERIFIED 85K RESTART (2026-09-16): both PP stages passed memory profiling,
# /v1/models reported max_model_len=87040, and a chat completion succeeded.
# Previously verified pair: 80.5.9.135 PP0, 80.5.9.127 PP1, TP16/PP2/EP.
# This variant changes only max-model-len (40960 -> 87040) and log directory.
# 87040 = 85 * 1024. Actual request length also depends on tokenizer/prompt format.
set -euo pipefail
...
log_dir=/home/w00985415/pp2_glm_ep_135_127_85k_20260916
