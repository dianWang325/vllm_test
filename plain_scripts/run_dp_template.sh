...
case "$role" in
  prefill)
    ...
    exec vllm serve "$model" \
      ...
      --additional-config '{"scheduler_config":{"profiling_chunk_config":{"enabled":true,"smooth_factor":1,"need_timing":true},"short_request_first_config":{"enabled":true,"threshold":65546,"long_max_wait_ms":2000}}}' \
