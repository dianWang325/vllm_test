...
log_dir=/home/w00985415/pp2_glm_ep_126_127_85k_20260916
...
printf 'role=%s host=%s peer=%s max_model_len=87040 started=%s\n' "$role" "$local_ip" "$(if [ "$role" = head ]; then echo 80.5.9.127; else echo 80.5.9.126; fi)" "$(date -Is)" > "$log_dir/${role}.meta"
