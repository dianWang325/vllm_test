#!/usr/bin/env bash
# VERIFIED 2026-09-16: 80.5.9.135 PP0 + 80.5.9.127 PP1, TP16/PP2/EP,
# max-model-len=40960; 32 ranks passed profile_run and a chat request returned 200.
set -euo pipefail
...
log_dir=/home/w00985415/pp2_glm_ep_135_127_20260916
