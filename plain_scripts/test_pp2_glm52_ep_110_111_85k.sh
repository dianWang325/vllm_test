#!/usr/bin/env bash
# GLM-5.2 TP16/PP2/EP deployment on 80.5.17.110 (PP0) and 80.5.17.111 (PP1).
# Re-run the 85K prefill benchmark with fixed-request concurrency 1.
set -euo pipefail
...
log_dir=/home/w00985415/pp2_glm_ep_110_111_85k_20260916
