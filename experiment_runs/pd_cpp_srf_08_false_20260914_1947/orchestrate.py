...
def run_one(index: int, mode: str, dataset: str) -> None:
    ...
    status = {
        ...
        "p_comm_ip": MANIFEST.get("p_comm_ip", P_HOST),
        "d_comm_ip": MANIFEST.get("d_comm_ip", D_HOST),
    ...
    try:
        d_command = [
            ...
            "--local-ip", MANIFEST.get("d_comm_ip", D_HOST), "--nic-name", MANIFEST["d_nic"],
        ]
        ...
        p_command = [
            ...
            "--local-ip", MANIFEST.get("p_comm_ip", P_HOST), "--nic-name", MANIFEST["p_nic"],
        ]
