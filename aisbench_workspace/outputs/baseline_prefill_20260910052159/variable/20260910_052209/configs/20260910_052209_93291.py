...
datasets=[
    dict(abbr='vtest_data',
        ...
        path='/home/w00985415/vllm_test/aisbench_workspace/datasets/formal/prefill_variable-5b4fed2cabe4-0456091c355d.jsonl',
        reader_cfg=dict(
            input_columns=[
                'question',
                'max_out_len',
...
work_dir='/home/w00985415/vllm_test/aisbench_workspace/outputs/baseline_prefill_20260910052159/variable/20260910_052209'